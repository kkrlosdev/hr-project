...
import { ResourceSection } from "@/app/components/ResourcesSection"
// Next Components
    ...
    return(
        ...
        {isLoading?(
            ...
            <div className="flex items-center justify-center">
                <h1 className="my-5 text-3xl font-semibold text-white shadow-2xl">PDF&#39;s y Recursos Descargables</h1>
            </div>
            <main className="flex flex-wrap items-center justify-center overflow-auto gap-y-6 gap-x-5 mt-[50px]">

                <ResourceSection backgroundColor="rgba(199, 21, 21, 0.85)">
                ...
                <ResourceSection backgroundColor="rgba(052, 044, 125, 0.85)">
                    <h2 className="absolute font-semibold text-white top-10">2. Charla de la ONU sobre los Derechos Humanos</h2>
                ...
                <ResourceSection backgroundColor="rgba(000, 161, 200, 0.85)">
                    <h2 className="absolute font-semibold text-white top-10">3. Sitio web oficial sobre los Derechos Humanos</h2>
                    <Link href="https://www.ohchr.org/es/ohchr_homepage" target="_blank" className="absolute flex items-center justify-center w-32 h-10 p-1 text-center text-white transition border rounded bottom-6 border-cyan-200 bg-cyan-600 hover:bg-opacity-10">
                ...
                <ResourceSection backgroundColor="rgba(197, 022, 087, 0.85)">
