        ...
        {isLoading?(
            ...
            <main className="flex flex-wrap items-center justify-center overflow-auto gap-y-6 gap-x-5 mt-[50px]">
                ...
                <ResourceSection backgroundColor="rgba(199, 21, 21, 0.85)">
                    <h2 className="absolute font-semibold text-white top-10">1. Proceso de Remediación en Gelco</h2>
                ...
                <ResourceSection backgroundColor="rgba(052, 044, 125, 0.85)">
                    <h2 className="absolute font-semibold text-white top-10">2. Línea ética y Contacto en Gelco</h2>
                ...
                <ResourceSection backgroundColor="rgba(000, 161, 200, 0.85)">
                    <h2 className="absolute font-semibold text-white top-10">3. Artículo adicional sobre el Proceso de Remediación</h2>
                ...
                <ResourceSection backgroundColor="rgba(197, 022, 087, 0.85)">
                    <h2 className="absolute font-semibold text-white top-10">4. Infografía sobre la Remediación</h2>
