...
export function Footer(){
    return(
        <>
            <footer className="flex items-center justify-between w-full h-full mt-10 text-slate-300 bg-blue-gelco">
                <div className="flex flex-col items-center ml-[170px] my-8">
                    <div className="my-6 ml-4">
                        <Image src={LogoBlanco} height={130} width={130} alt="Logo Gelco"/>
                    </div>
                    <p className="ml-6 text-white">¡Construyendo la Gelco del futuro!</p>
                </div>
